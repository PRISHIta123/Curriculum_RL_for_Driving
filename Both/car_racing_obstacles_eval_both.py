...
class CarRacingObstaclesEvalBoth(gym.Env, EzPickle):
    ...
    def step(self, action):
        ...
        return self.state, step_reward, done, {"num_obstacles": self.num_obstacles, "num_collisions": self.num_collisions, "tiles": self.tile_visited_count, "grass_time": self.total_grass_timesteps, "total_time": self.total_road_or_obstacle_timesteps}
